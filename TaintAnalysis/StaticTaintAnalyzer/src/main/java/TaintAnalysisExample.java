...
public class TaintAnalysisExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL resource = TaintAnalysisExample.class.getResource("Example4.jar");
        AnalysisScope scope = AnalysisScopeReader.makeJavaBinaryAnalysisScope(resource.getPath(), exFile);
        String runtimeClasses = TaintAnalysisExample.class.getResource("jdk-17.0.1/rt.jar").getPath();
